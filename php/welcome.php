                    ...
                    <div class="col-lg-6">
                        <div class="ps-lg-5">
                            ...
                            <p class="display-28 mb-1-8">Bachelor of
                                ...
                                Engineering, Royal University of Phnom Penh is designed to provide high-
                                quality training in Information Technology which meets the current and
                            ...
                            <a href="#!" class="butn style-one fill">Get
                                Started</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row pb-6 pb-sm-8 pb-lg-10">
                    <div class="col-sm-6 col-lg-4 mb-4 mb-sm-5 mb-lg-0">
                        ...
                        <h5 class="h6 font-weight-300 line-height-normal text-white-90 w-md-85 mb-4">
                            <span class="text-warning">ITE</span> drive
                            you to the professional level.
                        </h5>
